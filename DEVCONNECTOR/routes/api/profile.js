...
//@desc     creat update users profile
//@access   Private
router.post( '/',[auth,
        [
    ...
    //define social undefined problem
...
router.delete('/experience/:exp_id',auth,async(req,res)=>{
    try{
        ...
        //get remove index
        const removeIndex= profile.experience.map(item=>item.id).indecOf(req.params.exp_id);
...
router.delete('/education/:edu_id',auth,async(req,res)=>{
    try{
        ...
        //get remove index
        const removeIndex= profile.education.map(item=>item.id).indecOf(req.params.edu_id);
